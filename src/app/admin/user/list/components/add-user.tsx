...
import { useAddCustomerMutation } from '@/hooks/queries/useAccount'
import { CreateCustomerAccountBodySchema, CreateCustomerAccountBodyType } from '@/schemas/account.schema'
