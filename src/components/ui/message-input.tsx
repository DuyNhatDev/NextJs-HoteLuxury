...
import { useAudioRecording } from '@/hooks/ui/use-audio-recording'
      ...
      <div className='absolute top-3 right-3 z-20 flex gap-2'>
        ...
        {isGenerating && stop ? (
          ...
          <Button
            type='submit'
            size='icon'
            className='h-8 w-8 bg-blue-500 transition-opacity hover:bg-blue-600'
...
function TranscribingOverlay() {
  return (
    ...
    >
      ...
      <p className='text-muted-foreground mt-4 text-sm font-medium'>Transcribing audio...</p>
    </motion.div>
  )
}
