...
import { useAddPartnerMutation } from '@/hooks/queries/useAccount'
import { CreatePartnerAccountBodySchema, CreatePartnerAccountBodyType } from '@/schemaValidations/account.schema'
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent className='max-h-screen overflow-auto sm:max-w-[600px]'>
        ...
        <DialogFooter>
          <Button type='submit' form='add-partner-form' className=''>
