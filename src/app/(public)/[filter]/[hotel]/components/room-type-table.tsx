      ...
      <Table className="mt-4 w-full table-fixed border-collapse border">
        <TableHeader className="bg-gray-200">
          <TableRow>
            ...
            <TableHead className="w-[23.32%] border text-center text-lg font-semibold text-blue-900">Tổng giá</TableHead>
            <TableHead className="w-[18.65%] border text-right text-lg font-semibold text-blue-900">Giữ phòng</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {roomTypeList.map((rt) => {
            ...
            return (
              <TableRow key={rt.roomTypeId} className="hover:bg-transparent">
                ...
                <TableCell className="mt-2 w-[18.65%] border text-right align-top">
                  <Button className="mt-2 rounded bg-orange-400 text-[15px] font-bold hover:bg-orange-400">
                    Yêu cầu đặt
                  </Button>
                </TableCell>
              </TableRow>
