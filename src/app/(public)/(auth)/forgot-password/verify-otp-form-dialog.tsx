...
import { VerifyForgotPasswordBodySchema, VerifyForgotPasswordBodyType } from '@/schemaValidations/auth.schema'
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className='w-full space-y-6'>
                ...
                <Button type='submit' className='w-full bg-blue-500 hover:bg-blue-600'>
                  {verifyForgotPasswordMutation.isPending && <LoaderCircle className='mr-2 h-5 w-5 animate-spin' />}
                  Xác nhận
                </Button>
              </form>
            </Form>
