...
import AlertDialogRejectPartner from '@/app/admin/partner/pending/components/reject-partner'
import AlertDialogConfirmPartner from '@/app/admin/partner/pending/components/confirm-partner'
        ...
        <div className='flex items-center justify-end space-x-2 pt-4'>
          ...
          <div>
            <AutoPagination
              ...
              pathname='/admin/partner/pending'
            />
          </div>
        </div>
      </div>
