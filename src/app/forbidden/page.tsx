export default function NotFoundPage() {
  return (
    <div className='flex min-h-screen flex-col items-center justify-center bg-transparent text-center'>
      <svg
        className='whistle mb-8 w-[20%] fill-[#f95959]'
      ...
      <h1 className='mb-5 text-6xl font-bold text-[#facf5a]'>403</h1>
      <h2 className='text-xl font-light text-[#455d7a] uppercase'>Bạn không có quyền truy cập vào trang này</h2>
    </div>
  )
}
